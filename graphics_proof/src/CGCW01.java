...
public class CGCW01{
	...
	class Renderer implements GLEventListener, KeyListener {
		...
		public void display(GLAutoDrawable drawable) {
			...
			//Look at line 76-78 for initial xtranslate, ytranslate and ztranslate values
			T.translate(xtranslate, ytranslate, ztranslate);
			//Look at line 79-81 for initial rotateXangle, rotateYangle and rotateZangle values
...
//		    gl.glDepthFunc(GL_LESS);
		...
		public void keyPressed(KeyEvent ke) {
			//Find the scale, xtranslate, ytranslate, ztranslate,
			// xangle, yangle, zangle in the Renderer class from line 55
...
// This rotates around the X axis clockwise by 15 degrees (i.e, rotate away from your view)
			case KeyEvent.VK_X:
				rotateXangle -= 15;
				break; //Complete
// This rotates around the X axis anti-clockwise by 15 degrees (i.e. rotate towards your view)
			case KeyEvent.VK_C:
				rotateXangle += 15;
				break; //Complete
// rotate the object around Y axis clockwise or anti-clockwise
				// when the key 'Y' or 'U' is pressed
	// This rotates around the Y axis clockwise
			case KeyEvent.VK_Y:
				rotateYangle -= 15;
				break; //Complete
// This rotates around the Y axis anti-clockwise
			case KeyEvent.VK_U:
				rotateYangle += 15;
				break; //Complete
			}								
